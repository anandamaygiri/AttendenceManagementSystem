...
import updateGraduation from '@salesforce/apex/NewCandidateDetails.updateGraduation';
...
export default class graduation extends NavigationMixin (LightningElement) {
    ...
    handleInputChange(event)
    {
      if(event.target.name == 'graduationstateofUniversity')
        this.graduationRecord.graduationstateofUniversity = event.detail.value;
        console.log('stateofcollege--->' , this.graduationRecord.graduationstateofUniversity);

    if(event.target.name=='graduationnameofUniversity')
        this.graduationRecord.graduationnameofUniversity = event.detail.value;

    if(event.target.name=='graduationstateofcollege')
        this.graduationRecord.graduationstateofcollege = event.detail.value;
    ...
    handleClick() {
           console.log('OK button clicked!!');
            console.log('state of University is---' + this.graduationRecord.graduationstateofUniversity);
            console.log('name of University---' + this.graduationRecord.graduationnameofUniversity);
            console.log('state of college is----' + this.graduationRecord.graduationstateofcollege);
            console.log('city district of college----' + this.graduationRecord.graduationcitydistrictofcollege);
            console.log('name of college----' + this.graduationRecord.graduationnameofcollege);
            console.log('roll no---' + this.graduationRecord.graduationUniversityrollno);
            console.log('branch---' + this.graduationRecord.graduationbranchorsubject);
            console.log('elective----' + this.graduationRecord.graduationelectivesubjects);
            console.log('cgpa----' + this.graduationRecord.graduationpercentagecgpa);
            console.log('date month year of Passing----' + this.graduationRecord.graduationdatemonthyearofPassing);
            console.log('Entered record-----' + JSON.stringify(this.graduationRecord));
            console.log("Record ID--->", this.recordId);

        if (this.graduationRecord) {
            updateGraduation({ wrapRecord: JSON.stringify(this.graduationRecord),recordId: this.recordId})
                  .then(result => {
                  ...
                  .catch((error) => {
                      ...
                      this.dispatchEvent(new ShowToastEvent({
                        title: "Error",
                        message: "Error in saving Graduation details: " + error.message,
                        variant: "error",
                    })
                  );
              });
